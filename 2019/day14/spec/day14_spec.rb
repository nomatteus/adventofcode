  ...
  describe "Part 1" do
    context "example 1" do
      ...
      it "returns correct answer" do
        expect(subject.run_part1).to eq(31)
      end
    end
    ...
    context "example 2" do
      ...
      it "returns correct answer" do
        expect(subject.run_part1).to eq(165)
      end
    end
    ...
    context "example 3" do
      ...
      it "returns correct answer" do
        expect(subject.run_part1).to eq(13312)
      end
    end
    ...
    context "example 4" do
      ...
      it "returns correct answer" do
        expect(subject.run_part1).to eq(180697)
      end
    end
    ...
    context "example 5" do
      ...
      it "returns correct answer" do
        expect(subject.run_part1).to eq(2210736)
      end
    end
  end
